...
class ActorNetwork(object):
    ...
    def __init__(
       ...
       action_dim, BATCH_SIZE, TAU, LEARNING_RATE
    ):
        self.sess = sess
        ...
        # self.model, self.weights, self.depth_front, self.grey_front, \
        #     self.depth_bottom, self.grey_bottom, self.depth_back, \
        #     self.grey_back, self.vel, self.pos = self.create_actor_network(
        #         depth_front_size, grey_front_size, depth_bottom_size,
        #         grey_bottom_size, depth_back_size, grey_back_size, vel_size,
        #         pos_size, action_dim
        #     )
        self.model, self.weights, self.depth_front, self.grey_front, \
            self.vel, self.pos = self.create_actor_network(
                depth_front_size, grey_front_size, depth_bottom_size,
                grey_bottom_size, depth_back_size, grey_back_size, vel_size,
                pos_size, action_dim
            )
        ...
        # self.target_model, self.target_weights, self.target_depth_front, \
        #     self.target_grey_front, self.target_depth_bottom, \
        #     self.target_grey_bottom, self.target_depth_back, \
        #     self.target_grey_back, self.target_vel, \
        #     self.target_pos = self.create_actor_network(
        #         depth_front_size, grey_front_size, depth_bottom_size,
        #         grey_bottom_size, depth_back_size, grey_back_size, vel_size,
        #         pos_size, action_dim
        #     )
    ...
    def train(self, states, action_grads):
        ...
        self.sess.run(
            self.optimize, feed_dict={
                ...
                # self.depth_bottom: states[2], self.grey_bottom: states[3],
                # self.depth_back: states[4], self.grey_back: states[5],
                self.vel: states[2], self.pos: states[3],
                self.action_gradient: action_grads
            }
        )
    ...
    def create_actor_network(
        self, depth_front_size, grey_front_size, depth_bottom_size,
        grey_bottom_size, depth_back_size, grey_back_size, vel_size,
        pos_size,
        action_dim
    ):
        ...
        return model, model.trainable_weights, depth_front_image, grey_front_image, vel, pos
